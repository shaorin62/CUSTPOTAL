...
<!--
	...
	function pop_report_cntupdate(ridx, midx) {
		var url = "/cust/board/report_cntupdate_proc.asp?ridx=" + ridx+"&midx="+midx;
		var name = "" ;
...
//			location.href="report_cntupdate_proc.asp?ridx=" + ridx+"&midx="+midx;
	...
	function pop_report_downcntupdate(ridx, midx) {
		var url = "/cust/board/report_downcntupdate_proc.asp?ridx=" + ridx+"&midx="+midx;
		var name = "" ;
