...
<%
	...
	dim a_val : a_val = (v_1_1 + v_1_2+  v_1_3 + v_1_4) / 4
	dim a_selval : a_selval = sel1_1 + sel1_2+  sel1_3 + sel1_4
	dim a_tot : a_tot = 30
	...
	dim c_val : c_val = (v_3_1 + v_3_2 + v_3_3 + v_3_4) / 4
	dim c_selval : c_selval =  sel3_1 + sel3_2 + sel3_3 + sel3_4
	dim c_tot : c_tot = 25
	...
	dim v_4_4 : v_4_4 = cint(request("4_4"))
	dim v_4_5 : v_4_5 = cint(request("4_5"))
	dim sel4_1 : sel4_1 = cint(request("sel4_1"))
	dim sel4_2 : sel4_2 = cint(request("sel4_2"))
	dim sel4_3 : sel4_3 = cint(request("sel4_3"))
	dim sel4_4 : sel4_4 = cint(request("sel4_4"))
	dim sel4_5 : sel4_5 = cint(request("sel4_5"))
	dim d_val : d_val = (v_4_1 + v_4_2 + v_4_3 + v_4_4 + v_4_5) / 4
	dim d_selval : d_selval = sel4_1 + sel4_2 + sel4_3 + sel4_4 + sel4_5
	dim d_tot : d_tot = 20
	...
	objrs.addnew
	objrs.fields("tidx").value = tidx
	objrs.fields("code").value = "sel4_4"
	objrs.fields("value").value = sel4_4
	objrs.update
	
	objrs.addnew
	objrs.fields("tidx").value = tidx
	objrs.fields("code").value = "sel4_5"
	objrs.fields("value").value = sel4_5
	objrs.update
...
<!--
	location.href = "validation_board.asp?contidx=<%=contidx%>&tidx=<%=tidx%>";
//-->
</SCRIPT>