...
<%
	...
	dim v_1_7 : v_1_7 = cint(request("1_7"))
	dim v_1_8 : v_1_8 = cint(request("1_8"))
	...
	dim sel1_7 : sel1_7 = cint(request("sel1_7"))
	dim sel1_8 : sel1_8 = cint(request("sel1_8"))
	dim a_val : a_val = (v_1_1 + v_1_2+  v_1_3 + v_1_4 + v_1_5 + v_1_6 + v_1_7 + v_1_8) / 4
	dim a_selval : a_selval = sel1_1 + sel1_2+  sel1_3 + sel1_4 + sel1_5 + sel1_6 + sel1_7 + sel1_8
	dim a_tot : a_tot = 40
	...
	dim b_val : b_val = (v_2_1 + v_2_2 + v_2_3) / 4
	dim b_selval : b_selval = sel2_1 + sel2_2 + sel2_3
	dim b_tot : b_tot = 20
	...
	dim e_val : e_val = (v_5_1 + v_5_2 ) / 4
	dim e_selval : e_selval = sel5_1 + sel5_2
	dim e_tot : e_tot = 5
	...
	if objrs.eof then
		...
		objrs.fields("value").value = sel1_7
		objrs.update

		objrs.addnew
		objrs.fields("tidx").value = tidx
		objrs.fields("code").value = "sel1_8"
		objrs.fields("value").value = sel1_8
		objrs.update
...
<!--
	location.href = "validation_led.asp?contidx=<%=contidx%>&tidx=<%=tidx%>";
//-->
</SCRIPT>