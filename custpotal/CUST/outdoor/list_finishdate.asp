...
<!--
		...
		function getexcel() {
			...
			location.href = "/cust/outdoor/excel/xls_finishdate.asp?custcode="+custcode+"&teamcode="+teamcode+"&cyear="+cyear+"&cmonth="+cmonth+"&cyear2="+cyear2+"&cmonth2="+cmonth2;
		}
            ...
            <td valign="top" height="516" colspan='2'>
				  ...
				  <thead>
					<tr height='30' align='center'>
						...
						<th class="hd center" width="67">내수액</th>		184   -
						<th class="hd center" width="47">내수율</th> -->
						<th class="hd center" width="192">광고주</th>
