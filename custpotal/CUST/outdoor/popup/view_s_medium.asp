...
'	Next
	...
	If pcrud = "d" Then server.transfer "/cust/outdoor/process/db_s_medium.asp"
...
//			}
			...
			frm.action = "/cust/outdoor/process/db_s_medium.asp";
			frm.method = "post";
			frm.submit();
		}
...
<div id="themeLayer"style="LEFT:10px; TOP:67px; width:520px; height:297px;position:absolute; z-index:10; background-color:#CCCCCC;border: 1px solid #333333;color:#000000;padding:10 10 10 10;font-weight:bolder;display:none;overflow:hidden;"><!--#include virtual="/cust/outdoor/inc/getsubseq.asp" --></div>

<div id="categoryLayer"style="LEFT:10px; TOP:67px; width:520px; height:297px;POSITION:absolute; z-index:11; background-color:#CCCCCC;border: 1px solid #333333;color:#000000;padding:10 10 10 10;font-weight:bolder;display:none;"><!--#include virtual="/cust/outdoor/inc/getMediumClass.asp" --></div>
