...
<!--
	...
	function getyear(){
		...
		sendRequest("/cust/outdoor/inc/getyear.asp", params, _getyear, "GET");
	}
	...
	function getmonth() {
		...
		sendRequest("/cust/outdoor/inc/getmonth.asp", params, _getmonth, "GET");
	...
	function getcontact() {
		...
		sendRequest("/cust/outdoor/inc/getcontactsummary_b.asp", params, _getcontact, "GET");
	}
	...
	function getcontactdetail () {
		...
		sendRequest("/cust/outdoor/inc/getcontactdetail_b.asp", params, _getcontactdetail, "GET");
	}
	...
	function getcontactphoto() {
		...
		sendRequest("/cust/outdoor/inc/getcontactphoto.asp", params, _getcontactphoto, "GET");
	}
	...
	function getmap() {
		// 매체 약도 관리
		var mdidx = "<%=mdidx%>";
		var url = "/cust/outdoor/popup/view_map.asp?mdidx="+mdidx ;
		var name = "winMap";
	...
	function getaccount(mdidx, side) {
		//광고 비용 관리
		var url = "/cust/outdoor/popup/view_account.asp?mdidx="+mdidx+"&side="+side+"&flag=B" ;
		var name = "winAccount";
		var left = screen.width / 2 - 550 / 2;
		var top = 10;
		var opt = "width=550, height=550, resizable=no, scrollbars=no, status=yes, left="+left+"&top="+top;
	...
	function getphoto(mdidx, side) {
		...
		var url = "/cust/outdoor/popup/view_photo.asp?mdidx="+mdidx+"&side="+side+"&lastdate="+lastdate+"&cyear=<%=pcyear%>&cmonth=<%=pcmonth%>" ;
		var name = "winPhoto";
	...
	function gettheme(mdidx, side) {
		...
		var url = "/cust/outdoor/popup/view_theme.asp?mdidx="+mdidx+"&side="+side+"&highcustcode=<%=highcustcode%>&lastdate="+lastdate+"&cyear=<%=pcyear%>&cmonth=<%=pcmonth%>" ;
		var name = "wintheme";
		var left = screen.width / 2 - 550 / 2;
		var top = 10;
		var opt = "width=550, height=550, resizable=no, scrollbars=no, status=yes, left="+left+"&top="+top;
	...
	function getprint() {
		var url = "/cust/outdoor/print/prt_b_contact2.asp?contidx=<%=pcontidx%>&cyear=<%=pcyear%>&cmonth=<%=pcmonth%>";
		var name = "Print";
...
//		alert(filename);
		process.location.href = "/cust/outdoor/print/convert_html.asp?filename="+filename+"&contidx=<%=pcontidx%>&cyear=<%=pcyear%>&cmonth=<%=pcmonth%>&flag=B";
	...
	function preview() {
		...
		var url = "/cust/outdoor/inc/viewPhoto.asp?src="+clickElement.src;
		var name = "preview";
	...
	function setmedium() {
		...
		var url = "/cust/outdoor/popup/view_b_medium3.asp?contidx=<%=pcontidx%>&cyear="+cyear+"&cmonth="+cmonth+"&side="+side+"&mdidx="+mdidx;
		var name = "medium";
	...
	function getmedium(crud) {
		...
		var url = "/cust/outdoor/popup/view_b_medium.asp?contidx=<%=pcontidx%>&cyear="+cyear+"&cmonth="+cmonth+"&side="+side+"&crud="+crud+"&mdidx="+mdidx;
		var name = "medium";
		var left = screen.width / 2 - 540 / 2;
	...
	function getmedium2() {
		var name = "medium";
		var mdidx = document.getElementById("mdidx").value;
		var url = "/cust/outdoor/popup/view_b_medium2.asp?contidx=<%=pcontidx%>&mdidx="+mdidx;
		var left = screen.width / 2 - 540 / 2;
		var top = screen.height / 2 - 596 / 2;
		var opt = "width=540, height=390, resizable=no, scrollbars=no, status=yes,left="+left+"&top="+top;
		window.open(url, name, opt);
	...
	function getreportphoto() {
		var url = "/cust/outdoor/popup/view_report_photo.asp?contidx=<%=pcontidx%>&cyear=<%=pcyear%>&cmonth=<%=pcmonth%>";
		var name = "Photo";
		var left = screen.width / 2 - 720 / 2;
		var top = 10;
		var opt = "width=720, height=550, resizable=no, scrollbars=no, status=yes, left="+left+"&top="+top;
	...
	function getvalidation() {
		...
		if (categoryidx == 9)
		{
			var url = "/cust/outdoor/validation_led.asp?contidx="+contidx ;
		}else if (categoryidx == 10)
		{
			var url = "/cust/outdoor/validation_neon.asp?contidx="+contidx ;
		}else if (categoryidx == 11)
		{
			var url = "/cust/outdoor/validation_board.asp?contidx="+contidx ;
		}else if (categoryidx == 135)
		{
			var url = "/cust/outdoor/validation_etc.asp?contidx="+contidx ;
		}
...
//		alert(clickElement.src);
	...
	window.onload = function () {
		...
		_sendRequest("/cust/outdoor/inc/getyear.asp", "contidx=<%=pcontidx%>&cyear=<%=pcyear%>", _getyear, "GET");
		var cyear = document.getElementById("cyear").value;
		_sendRequest("/cust/outdoor/inc/getmonth.asp", "contidx=<%=pcontidx%>&cyear=<%=pcyear%>&cmonth=<%=pcmonth%>", _getmonth, "GET");
