...
<%
	...
	Dim sql : sql = "select a.contidx, a.title, a.firstdate, a.startdate, a.enddate , isnull(totalprice, 0) totalprice, isnull(sum(monthly),0) monthly, isnull(sum(expense), 0) expense, a.custcode, a.flag, c.medcode, e.isHold from wb_contact_mst a inner join sc_cust_dtl b on a.custcode=b.custcode inner join wb_contact_md c on a.contidx=c.contidx inner join wb_contact_exe d on c.mdidx = d.mdidx and d.cyear = '"&cyear&"' and d.cmonth = '"&cmonth&"'  left outer join wb_contact_trans e on a.contidx=e.contidx and c.medcode=e.medcode and e.cyear='"&cyear&"' and e.cmonth='"&cmonth&"'  where a.startdate  <= '"&edate&"' and a.enddate >= '"&sdate&"' and b.highcustcode like '"&pcustcode&"%' and a.custcode like '"&pteamcode&"%' "& strwhere &" group by a.contidx, a.title, a.firstdate, a.startdate, a.enddate ,a.totalprice ,a.custcode ,a.flag, c.medcode, e.isHold order by a.contidx desc"
...
<!--
		...
		function submitchange() {
			...
			frm.action = "/cust/outdoor/process/db_transaction.asp";
			frm.method = "post";
			frm.submit();
		}
...
<form action="list_transaction.asp" method='post'>
          ...
          <tr>
			...
			<table width="1030" height="35" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td  align="right" background="/images/bg_search.gif" > <A HREF="#" onclick="getAccept();  return false;"><img src="/images/btn_execution.gif" width="78" height="18" align="absmiddle" border="0" ></A> <A HREF="#" onclick='getAcceptCancel();  return false;'><img src="/images/btn_execution_cancel.gif" width="78" height="18" align="absmiddle" border="0" ></A> <!-- <A HREF="#" onclick="getHoldCancel(); return false;"><img src="/images/btn_hold_cancel.gif" width="78" height="18" align="absmiddle" border="0" ></A> --></td>
                  <td width="13" ><img src="/images/bg_search_right.gif" width="13" height="35"></td>
                </tr>
            </table></td>
          </tr>
          <tr>
            <td height="35" ><img src='/images/unlock.gif' width='16' height='16' alt='정산되지 않은 상태'> 미결 <img src='/images/lock.gif' width='16' height='16' alt='정산 요청 중 RMS에서 정산승인 처리전 상태'> 대기 <img src='/images/hold.gif' width='16' height='16' alt='RMS에서 정산승인 완료' hspace=2> 승인 <!-- <img src='/images/unhold.gif' width='16' height='16' alt='RMS에서 정산취소 대기' hspace=2> 취소 --> </td>
