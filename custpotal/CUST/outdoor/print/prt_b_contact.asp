...
<%
	Dim pcontidx : pcontidx = request("pcontidx")
	If pcontidx = "" Then pcontidx = request("contidx")
...
'	response.write pcontidx
	...
	' 광고 계약 기초 정보
	Dim sql : sql = "select c.title, c.comment, c.mediummemo, c.regionmemo, m.map, m.mdidx, t.highcustcode, c.startdate, c.enddate   from wb_contact_mst c "
...
<link href="http://mms.raed.co.kr/cust/outdoor/style.css" rel="stylesheet" type="text/css">
<script type="text/javascript">
<!--
	window.onload = function () {
		
		self.focus();
//		document.execCommand('SaveAs', true, 'test.html');
	}
//-->
</script>
</head>
...
<table width="1024"   align="center" style="margin-top:30px;">
	<tr>
		<td class="title"><img src="http://mms.raed.co.kr/images/ico_subtitle.gif" width="28" height="17" align="absmiddle"><%=title%> </td>
	</tr>
</table>
<% server.execute("/cust/outdoor/print/prt_contactsummary_b.asp") %>
<% server.execute("/cust/outdoor/print/prt_contactdetail_b.asp") %>
...
<table width="1024" align="center" style="margin-top:10px;">
	<tr>
	  ...
	  <td rowspan='3' width='230'  class="context" id='map'><%If IsNull(rs("map")) Then response.write "<img src='http://mms.raed.co.kr/images/noimage.gif' width='230' height='190'>" Else response.write "<img src='http://mms.raed.co.kr/pds/media/"&rs("map")&"' width='230' height='190'>"%></td>
	</tr>
	<tr>
