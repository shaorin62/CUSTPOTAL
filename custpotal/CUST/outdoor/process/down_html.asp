...
'	Next
'	response.End
	Dim mpath : mpath = "\\11.0.12.201\adportal\print\"
	Dim dpath : dpath = "\\11.0.12.201\adportal\report\"
	Dim murl : murl = "http://mms.raed.co.kr/pds/print\"
	Dim durl : durl = "http://mms.raed.co.kr/pds/report\"
...
%>
	...
	Sub OpenDownloadMonitor()
		...
		window.open "/cust/outdoor/popup/FileDownloadMonitor.htm",null,winstyle
	End Sub
	OpenDownloadMonitor()
</script>
