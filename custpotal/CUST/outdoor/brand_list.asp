          ...
          <tr>
            <td >			<table width="1030" height="35" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="left" background="/images/bg_search.gif"> 계약검색 <%call get_year(cyear)%><%call get_month(cmonth)%>&nbsp;  <span id="custcode2"><%call get_blank_select("사업부를 선택하세요", 207)%></span><span id='jobcust'><%call get_blank_select("브랜드를 선택하세요", 207)%></span><span id='thema'><%call get_blank_select("소재를 선택하세요", 207)%></span> <img src="/images/btn_search.gif" width="39" height="20" align="top" class="styleLink" onclick="go_search();"> </td>
