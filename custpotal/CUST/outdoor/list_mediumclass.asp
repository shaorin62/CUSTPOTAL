...
<!--
	...
	// 대분류 코드
		...
		_sendRequest("/cust/outdoor/inc/gethighclass.asp", params, _gethighclass, "GET");
		_sendRequest("/cust/outdoor/inc/getmiddleclass.asp", null, _getmiddleclass, "GET");
		_sendRequest("/cust/outdoor/inc/getlowclass.asp", null, _getlowclass, "GET");
		_sendRequest("/cust/outdoor/inc/getdetailclass.asp", null, _getdetailclass, "GET");
	}
	...
	// 중분류 코드
		...
		_sendRequest("/cust/outdoor/inc/getmiddleclass.asp", params, _getmiddleclass, "GET");
		_sendRequest("/cust/outdoor/inc/getlowclass.asp", null, _getlowclass, "GET");
		_sendRequest("/cust/outdoor/inc/getdetailclass.asp", null, _getdetailclass, "GET");
	...
	// 소분류 코드
		...
		_sendRequest("/cust/outdoor/inc/getlowclass.asp", params, _getlowclass, "GET");
		_sendRequest("/cust/outdoor/inc/getdetailclass.asp", null, _getdetailclass, "GET");
	}
	...
	// 세분류 코드
		...
		sendRequest("/cust/outdoor/inc/getdetailclass.asp", params, _getdetailclass, "GET");
	...
	window.onload = function () {
		_sendRequest("/cust/outdoor/inc/gethighclass.asp", null, _gethighclass, "GET");
		_sendRequest("/cust/outdoor/inc/getmiddleclass.asp", null, _getmiddleclass, "GET");
		_sendRequest("/cust/outdoor/inc/getlowclass.asp", null, _getlowclass, "GET");
		_sendRequest("/cust/outdoor/inc/getdetailclass.asp", null, _getdetailclass, "GET");
	}
