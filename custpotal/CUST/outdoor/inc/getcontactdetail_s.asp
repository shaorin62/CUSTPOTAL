...
<table width="1024" align="center" cellpadding=0>
	<thead>
		<tr>
			...
			<th width="280" class="detail">매체위치</th> <!--  + 90 -->
			<th width="140" class="detail">규격 / 재질</th> <!--  + 90 -->
			...
			<th width="219" class="detail">매체사</th>
		</tr>
	</thead>
	<tbody>
<%
...
%>
		<tr>
			...
			<td class="context2"  style="padding-left:3px;" ><%=getmedname(medcode)%></td>
		</tr>
<%
		rs.movenext
	Loop
