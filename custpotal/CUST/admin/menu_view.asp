          ...
          <tr>
            <td class="bdpdd"><table border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <tr>
                  <td  height="50" valign="bottom"><a href="/cust/admin/menu_list.asp?selcustcode2=<%=custcode2%>&menunum=<%=request.cookies("menunum")%>"><img src="/images/btn_list.gif" width="59" height="20" border="0"></a></td>
