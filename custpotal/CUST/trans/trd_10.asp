...
<TABLE  width="100%">
	<TR>
		<TD ><img src="/images/ico_subtitle.gif" width="28" height="17" align="absmiddle"><span class="subtitle" id="subtitle"> 매체별 광고비</span></TD>
		<TD  align="right" valign="top">  <span class="navigator"  id="navigate">광고비집행 &gt;  매체별 광고비</span></TD>
	</TR>
</TABLE>
</div>
...
<!-- 검색 영역 -->
	...
	<table width="1030" height="35" border="0" cellpadding="0" cellspacing="0" >
	   <tr>
		 ...
		 <td width="80%" align="left" background="/images/bg_search.gif"><%=search_cyearcmonth(cyear, cmonth, custcode2)%> <A HREF="#" ><img src="/images/btn_search.gif" width="39" height="20" align="absmiddle" border="0" onclick="getdata('trd_10.asp'); return false;"></A></td>
		 <td width="20%" align="right" background="/images/bg_search.gif"><img src="/images/btn_excel.gif" width="85" height="22" align="absmiddle" vspace="5" class="stylelink" onclick="get_excel_sheet('trans_10.asp');"></td>
