...
<table id="Table_01" width="1240" height="80" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="210" height="70" rowspan="2" valign="top"><a href="/hq/main.asp"><img src="/images/top_01.gif" width="210" height="80" alt="go main" border="0"></a></td>
...
<%
response.cookies("cookiemidx").expires = date() - 1
%>