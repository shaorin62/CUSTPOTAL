		...
		function _getdata() {
			...
			if (xmlreq.readyState == 4) {
				if (xmlreq.status == 200) {
						...
						process.innerHTML = "<img src='http://ymail.net/skin/default/images/loding_clock.gif' style='margin-top:100px;'>" ;
				}
			}
		}
...
//==================================menu.asp=============================================
   function pop_menu_reg() {
	...
	function go_submenu_reg(idx, gubun, mc) {
		var flag = document.forms[0].tflag.value.replace("null","") ;

		var url = "pop_submenu_reg.asp?midx="+idx  +"&tflag=" +flag + "&gubun=" + gubun + "&mc=" + mc ;
...
<!--#include virtual="/hq/top.asp" -->
  ...
  <table width="1240" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="Table_01">
    <tr>
      <td valign="top"><!--#include virtual="/hq/left_admin_menu.asp"--></td>
