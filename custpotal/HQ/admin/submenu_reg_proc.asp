...
<%
	...
	sql  = "select midx, title, custcode,  lvl, isfile, iscomment, isemail, isuse, cuser, cdate, uuser, udate, ref, highmenu, mp, attr01, attr02, mc from dbo.wb_menu_mst"
	call set_recordset(objrs, sql)
	...
	objrs.fields("attr02").value = gubun
	objrs.fields("mc").value = mc
	objrs.update
	objrs.close
