          ...
          <tr>
            <td class="bdpdd"><table width="800" border="1" cellpadding="0">
              <tr>
                ...
                <td colspan="3"><input name="txtmenuname" type="text" id="txtaccount" maxlength="12"> </td>
              </tr>
              <tr>
                <td height="30">사업부</td>
              ...
              <tr>
                <td height="30">&nbsp;</td>
                <td colspan="3"><input type="checkbox" name="chksub" onclick="checkForSubmenu();"> 하위메뉴로 등록하시려면 체크하세요.</td>
              </tr>
              <tr>
                <td height="30">상위메뉴</td>
                <td colspan="3"><span id="topmenu"><select name="selhighmenuidx" readonly>
					<option value="" selected> 상위메뉴에 해당할 메뉴를 선택하세요.
                </select></span> </td>
              </tr>
              <tr>
