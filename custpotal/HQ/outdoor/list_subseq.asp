...
<!--
	...
	// 광고주를 선택 했을때 실행
		...
		var seqno = "" ;
		var params = "highcustcode="+custcode+"&seqno="+seqno ;
...
//		document.getElementById("debugConsole").innerHTML = params;
		sendRequest("/hq/outdoor/inc/setsubno.asp", params, getsubbrandcode, "GET");
		document.getElementById("txtsubname").value = "";
	}
	...
	function setthmno(crud) {
		...
		sendRequest("/hq/outdoor/inc/setthmno.asp", params, getthemecode, "GET");
		document.getElementById("txtthmname").value = "";
	}
