...
<table width="1024" align="center" style="margin-top:10px;">
	<tr>
	  ...
	  <td rowspan='3' width='230'  class="context2" id='map'><%If IsNull(rs("map")) Then response.write "<img src='/images/noimage.gif' width='230' height='190'>" Else response.write "<img src='/pds/media/"&rs("map")&"' width='230' height='190'>"%></td>
	</tr>
	<tr>
