...
<% server.execute("/hq/outdoor/print/prt_contactsummary_b.asp") %>
<% server.execute("/hq/outdoor/print/prt_contactdetail_b.asp") %>
...
<table width="1024" align="center" style="margin-top:10px;">
	<tr>
	  ...
	  <td rowspan='3' width='230'  class="context" id='map'><%If IsNull(rs("map")) Then response.write "<img src='http://10.110.10.86:6666/images/noimage.gif' width='230' height='190'>" Else response.write "<img src='http://10.110.10.86:6666/pds/media/"&rs("map")&"' width='230' height='190'>"%></td>
	</tr>
	<tr>
