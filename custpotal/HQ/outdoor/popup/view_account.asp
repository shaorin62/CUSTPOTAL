...
'	Call getquerystringparameter
	...
	Dim sql :  sql = "select a.seq, a.cyear, a.cmonth, a.monthly, a.expense, b.ishold from wb_contact_exe a left outer join ( select a.cyear, a.cmonth, a.contidx, a.isHold, b.mdidx from ( select cyear, cmonth, contidx, ishold, medcode from wb_contact_trans group by cyear, cmonth, contidx, ishold, medcode) a left outer join wb_contact_md b on a.contidx=b.contidx and a.medcode = b.medcode) as b on a.mdidx=b.mdidx and a.cyear=b.cyear and a.cmonth=b.cmonth where a.mdidx=? and a.side=?"
...
<head>
	...
	<!--
		...
		function submitchange() {
			...
			frm.action = "/hq/outdoor/process/db_account.asp";
			frm.method = "post";
			frm.submit();
		}
