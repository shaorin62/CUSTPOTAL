		...
		<meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
			...
			<!--	
				...
				function submitchange() {
					...
					frm.action = "/hq/outdoor/process/db_report_photo.asp";
					frm.method = "post";
					frm.submit();
...
<!--  -->
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr height='30'>
				...
				<td width='375' align='right' valign='bottom'>  <strong> <a href="#" onclick="submitchange(); return false;">111저장</a>  </strong> |  <strong> <a href="#" onclick="window.close(); return false;">닫기</a>  </strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
<!--  -->
	</td>
