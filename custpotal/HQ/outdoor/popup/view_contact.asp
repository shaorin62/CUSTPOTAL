...
<%
	...
	Dim sql : sql = " select c.title, c.firstdate, c.startdate, c.enddate, c.custcode, d.highcustcode, c.comment, c.regionmemo, c.mediummemo, c.flag, d2.custcode deptcode, isnull(md.cnt,0) cnt  from wb_contact_mst c inner join  sc_cust_dtl d on c.custcode = d.custcode left outer join sc_cust_dtl d2 on d.clientsubcode = d2. custcode left join  ( select contidx, count(*) cnt from wb_contact_md  where contidx = " & pcontidx & "  group by contidx ) md on c.contidx = md.contidx where c.contidx = " & pcontidx
...
<head>
	...
	<!--
		...
		function submitchange() {
			...
			frm.action = "/hq/outdoor/process/db_contact.asp";
			frm.method = "post";
			frm.submit();
		}
...
<!--  -->
			...
			<tr>
				...
				<td class="sc" style="padding-top:3px; padding-bottom:3px;" ><textarea name="txtcomment" id="txtcomment" onclick="checktextlength(this, 1000); return false;" onkeyup="checktextlength(this, 1000); return false;" class="reg"><%=comment%></textarea></td>
			</tr>
			<tr>
				<td colspan="2" bgcolor="#E7E7DE" height="1"></td>
			</tr>
			...
			<table border="0" cellpadding="0" cellspacing="0">
			<tr>
                  <td  align="right" valign="bottom" width='495' height='50'>  
				  <a href="#" onclick="submitchange(); return false;"><img src="/images/btn_save.gif" width="59" height="18"  vspace="5" border=0 hspace=10></a>
				  <a href="#" onclick="window.close(); return false;"><img src="/images/btn_close.gif" width="57" height="18" vspace="6" border=0 ></a><br>
				  * 저장을 끝내시려면 닫기 버튼을 누르세요.</td>
                </tr>
			</table>
<!--  -->
	</td>
