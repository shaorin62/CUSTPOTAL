...
<!--
	...
	// 대분류 코드 
		...
		_sendRequest("/hq/outdoor/inc/gethighclass.asp", params, _gethighclass, "GET");
		_sendRequest("/hq/outdoor/inc/getmiddleclass.asp", null, _getmiddleclass, "GET");
		_sendRequest("/hq/outdoor/inc/getlowclass.asp", null, _getlowclass, "GET");
		_sendRequest("/hq/outdoor/inc/getdetailclass.asp", null, _getdetailclass, "GET");
	}
	...
	// 중분류 코드 
		...
		_sendRequest("/hq/outdoor/inc/getmiddleclass.asp", params, _getmiddleclass, "GET");
		_sendRequest("/hq/outdoor/inc/getlowclass.asp", null, _getlowclass, "GET");
		_sendRequest("/hq/outdoor/inc/getdetailclass.asp", null, _getdetailclass, "GET");
	...
	// 소분류 코드
		...
		_sendRequest("/hq/outdoor/inc/getlowclass.asp", params, _getlowclass, "GET");
		_sendRequest("/hq/outdoor/inc/getdetailclass.asp", null, _getdetailclass, "GET");
	}
	...
	// 세분류 코드
		...
		sendRequest("/hq/outdoor/inc/getdetailclass.asp", params, _getdetailclass, "GET");
	...
	window.onload = function () {
		_sendRequest("/hq/outdoor/inc/gethighclass.asp", null, _gethighclass, "GET");
		_sendRequest("/hq/outdoor/inc/getmiddleclass.asp", null, _getmiddleclass, "GET");
		_sendRequest("/hq/outdoor/inc/getlowclass.asp", null, _getlowclass, "GET");
		_sendRequest("/hq/outdoor/inc/getdetailclass.asp", null, _getdetailclass, "GET");
	}
