...
<%
	...
	sql = sql  & " where c.startdate <= '"&edate&"' and c.enddate >= '"&sdate&"' and d.highcustcode like '"&pcustcode&"%' and c.custcode like '"&pteamcode&"%' and c.title like '%"&pmedname&"%' "
...
//				sendRequest("/hq/outdoor/process/db_delete_contact.asp", params, _getcontactdelete, "GET");
		...
		function getexcel() {
			...
			location.href = "/hq/outdoor/excel/xls_contact.asp?custcode="+custcode+"&teamcode="+teamcode+"&cyear="+cyear+"&cmonth="+cmonth;
		}
