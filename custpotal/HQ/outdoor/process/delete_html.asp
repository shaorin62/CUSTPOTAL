...
'	response.End
	...
	Set cmd = Nothing
		...
		response.write "<script> alert('선택한 파일이 삭제되었습니다.'); parent.location.replace('/hq/outdoor/list_report.asp?cmbcustcode="&request("cmbcustcode")&"&cmbteamcode="&request("cmbteamcode")&"&cyear="&request("cyear")&"&cmonth="&request("cmonth")&"&menunum="&request("menunum")&"'); </script>"
%>
