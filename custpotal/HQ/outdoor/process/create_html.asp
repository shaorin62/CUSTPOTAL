...
'	response.End
	...
	For intLoop = 1 To request("contidx").count
		...
		If rs("flag") = "B" Then
			...
			Call MakeUrlToFile("http://10.110.10.86:6666/hq/outdoor/print/prt_b_contact.asp?contidx="&request("contidx")(intLoop)&"&cyear="&request("cyear")&"&cmonth="&request("cmonth"), filename,request("contidx")(intLoop),request("cyear"),request("cmonth"))
		Else
			filename = request("cyear")&request("cmonth")&"_"&getcustname(rs("custcode"))&"_"&getteamname(rs("custcode"))&"_00_"&rs("title")&"_00.html"
			Call MakeUrlToFile("http://10.110.10.86:6666/hq/outdoor/print/prt_s_contact.asp?contidx="&request("contidx")(intLoop)&"&cyear="&request("cyear")&"&cmonth="&request("cmonth"), filename,request("contidx")(intLoop),request("cyear"),request("cmonth"))
...
'	Call MakeUrlToFile("http://10.110.10.86:6666/hq/outdoor/print/prt_s_contact.asp?contidx="&request("contidx")&"&cyear="&request("cyear")&"&cmonth="&request("cmonth"), filename,request("contidx"),request("cyear"),request("cmonth"))
		...
		response.write "<script> alert('현황 파일을 생성하였습니다.'); parent.location.replace('/hq/outdoor/list_report.asp?cmbcustcode="&request("cmbcustcode")&"&cmbteamcode="&request("cmbteamcode")&"&cyear="&request("cyear")&"&cmonth="&request("cmonth")&"&menunum="&request("menunum")&"'); </script>"
%>
