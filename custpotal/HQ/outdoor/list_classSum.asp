...
<!--
		...
		function getexcel() {
			...
			location.href = "/hq/outdoor/excel/xls_classSum.asp?custcode="+custcode+"&teamcode="+teamcode+"&cyear="+cyear;
		}
	  ...
	  <table width="1030" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td valign="top" height="516" colspan='2'>
				  ...
				  <table border="0"width="1500" cellpadding="0" cellspacing="0" bordercolor="#8D652B" id="contact">
