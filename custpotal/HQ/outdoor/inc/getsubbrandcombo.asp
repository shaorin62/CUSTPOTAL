...
'	Dim sql : sql = "select subno, subname from wb_subseq_mst a inner join sc_subseq_dtl b on a.seqno=b.seqno  inner join sc_subseq_hdr c on c.highseqno=b.highseqno where c.highseqno = '" & phighseqno & "' order by subname"
'	response.write sql
