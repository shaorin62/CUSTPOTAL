			  ...
			  <%	do until objrs.eof %>
				<tr>
					...
					<td valign="top">
						...
						<tr>
							<td bgcolor="#FFFFFF" class="phhd"><b><% if not isnull(canceldate) then response.write "<del>"&title&"</del>" else response.write title %></b></td>
						</tr>
						</table>
