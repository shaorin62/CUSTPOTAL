...
<!--#include virtual="/hq/top.asp" -->
  <table id="Table_01" width="1280" border="1" cellpadding="0" cellspacing="0">
    <tr>
      <td rowspan="2" valign="top" width="210"><!--#include virtual="/hq/left_outdoor_menu.asp"--></td>
			...
			<tr>
                ...
                <tr>
				  ...
				  <table width="976" border="0" cellpadding="0" cellspacing="5" bgcolor="#EEEEEF">
                    <tr>
                      <td   align="center" valign="top"><img src="<%if photo_1 <> "" then response.write "/pds/media/"&photo_1&""" class='stylelink' " else response.write "/images/noimage.gif"%>" width="230" height="132" border="0" onclick="pop_medium_photo('<%=photo_1%>');" ></td>
                      <td  align="center" valign="top"><img src="<%if photo_2 <> "" then response.write "/pds/media/"&photo_2 &""" class='stylelink' "else response.write "/images/noimage.gif"%>" width="230" height="132" border="0" onclick="pop_medium_photo('<%=photo_2%>');"></td>
                      <td   align="center" valign="top"><img src="<%if photo_3 <> "" then response.write "/pds/media/"&photo_3 &""" class='stylelink' "else response.write "/images/noimage.gif"%>" width="230" height="132" border="0" onclick="pop_medium_photo('<%=photo_3%>');"></td>
                      <td  align="center" valign="top"><img src="<%if photo_4 <> "" then response.write "/pds/media/"&photo_4 &""" class='stylelink' "else response.write "/images/noimage.gif"%>" width="230" height="132" border="0" onclick="pop_medium_photo('<%=photo_4%>');"></td>
                    </tr>
                  </table>
				  </td>
                </tr>
...
<!--
	...
	function get_contact_medium_add(code) {
		var url = "/hq/outdoor/pop_contact_medium_reg.asp?contidx="+code;
	...
	function get_contact_medium_view(contidx, sidx, cyear, cmonth) {
		location.href="/hq/outdoor/pop_contact_view.asp?contidx="+contidx+"&sidx="+sidx+"&cyear="+cyear+"&cmonth="+cmonth;
	}
