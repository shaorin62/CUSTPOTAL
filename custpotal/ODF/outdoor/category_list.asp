      ...
      <td  height="600" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td ><table width="1030" height="31" border="3" cellpadding="0" cellspacing="0" bordercolor="#8D652B">
				...
				<% do until objrs.eof %>
                  <tr>
                    <td width="256" height="31"  style="padding-left:10px;"><%=ggroupname%></td>
                    <td width="3"></td>
                    <td width="256" style="padding-left:10px;"> &nbsp; <%=mgroupname%></td>
                    <td width="3"></td>
                    <td width="256" style="padding-left:10px;"> &nbsp; <%=sgroupname%></td>
                    <td width="3"></td>
                    <td width="256" style="padding-left:10px;"> &nbsp; <%=dgroupname%></td>
                  </tr>
                  <tr>
