...
<%
	...
	if not objrs.eof then
		set jobidx = objrs("jobidx")				' 소재번호
		set seqname = objrs("seqname")			' 브랜드코드
		set thema = objrs("thema")			' 브랜드명
		set custname = objrs("custname")		' 광고주명
		set custname2 = objrs("custname2")	' 사업부명
	end if
	dim mode : mode = null
    ...
    <tr>
	  ...
	  <table width="1002" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <TR>
				<TD width="50%"><img src="/images/ico_subtitle.gif" width="28" height="17" align="absmiddle"><span class="subtitle"> 소재현황 </span></TD>
				<TD width="50%" align="right"><span class="navigator" > 옥외관리 &gt; 매체관리 &gt; 소재현황</span></TD>
            </TR>
            </TABLE>
			</td>
          </tr>
                ...
                <tr>
                  <td><table width="1024" border="0" cellspacing="0" cellpadding="0" class="header">
                      <tr>
                        ...
                        <td width="214" align="center" >광고주 </td>
                        <td width="3" align="center" ><img src="/images/ico_head_clip.gif" width="3" height="25"></td>
                        <td width="170" align="center" >사업부</td>
                        <td width="3" align="center" ><img src="/images/ico_head_clip.gif" width="3" height="25"></td>
                        <td width="250" align="center" >브랜드</td>
                        <td width="3" align="center"><img src="/images/ico_head_clip.gif" width="3" height="25"></td>
                        <td width="350" align="center">소재명</td>
                      </tr>
                  </table></td>
                </tr>
              </table>
