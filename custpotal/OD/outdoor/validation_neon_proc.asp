...
<%
	...
	dim a_val : a_val = v_1_1 + v_1_2+  v_1_3 + v_1_4 + v_1_5 + v_1_6
	dim a_tot : a_tot = 30
	...
	dim d_val : d_val = v_4_1 + v_4_2 + v_4_3
	dim d_tot : d_tot = 10
	...
	dim v_5_3 : v_5_3 = cint(request("sel5_3"))
	dim v_5_4 : v_5_4 = cint(request("sel5_4"))
	dim e_val : e_val = v_5_1 + v_5_2 + v_5_3 + v_5_4
	dim e_tot : e_tot = 5
	...
	objrs.fields("value").value = v_5_3
	objrs.update

	objrs.addnew
	objrs.fields("tidx").value = tidx
	objrs.fields("code").value = "sel5_4"
	objrs.fields("value").value = v_5_4
	objrs.update
...
<!--
	location.href = "pop_validation_neon.asp?contidx=<%=contidx%>&tidx=<%=tidx%>&cyear=<%=cyear%>&cmonth=<%=cmonth%>";
//-->
</SCRIPT>