...
<%
	...
	dim a_val : a_val = v_1_1 + v_1_2+  v_1_3 + v_1_4
	dim a_tot : a_tot = 30
	...
	dim v_2_5 : v_2_5 = cint(request("sel2_5"))
	dim b_val : b_val = v_2_1 + v_2_2 + v_2_3 + v_2_4 + v_2_5
	dim b_tot : b_tot = 25
	...
	dim c_val : c_val = v_3_1 + v_3_2 + v_3_3 + v_3_4
	dim c_tot : c_tot = 25
	...
	dim v_4_3 : v_4_3 = cint(request("sel4_3"))
	dim v_4_4 : v_4_4 = cint(request("sel4_4"))
	dim v_4_5 : v_4_5 = cint(request("sel4_5"))
	dim d_val : d_val = v_4_1 + v_4_2 + v_4_3 + v_4_4 + v_4_5
	dim d_tot : d_tot = 20
	...
	objrs.fields("value").value = v_2_5
	objrs.update
	...
	objrs.fields("value").value = v_4_3
	objrs.update

	objrs.addnew
	objrs.fields("tidx").value = tidx
	objrs.fields("code").value = "sel4_4"
	objrs.fields("value").value = v_4_4
	objrs.update

	objrs.addnew
	objrs.fields("tidx").value = tidx
	objrs.fields("code").value = "sel4_5"
	objrs.fields("value").value = v_4_5
	objrs.update

	objrs.close


	sql = "select contidx, tidx from dbo.wb_validation_mst where tidx = " & tidx
	call set_recordset(objrs, sql)
...
<!--
	location.href = "validation_board.asp?contidx=<%=contidx%>&tidx=<%=tidx%>&cyear=<%=cyear%>&cmonth=<%=cmonth%>&validType=<%=validType%>";
//-->
</SCRIPT>