...
<%
	...
	dim a_val : a_val = v_1_1 + v_1_2+  v_1_3 + v_1_4 + v_1_5
	dim a_tot : a_tot = 30
	...
	dim v_2_6 : v_2_6 = cint(request("sel2_6"))
	dim b_val : b_val = v_2_1 + v_2_2 + v_2_3 + v_2_4 + v_2_5 + v_2_5
	dim b_tot : b_tot = 40
	...
	dim c_val : c_val = v_3_1 + v_3_2 + v_3_3
	dim c_tot : c_tot = 15
	...
	objrs.fields("value").value = v_2_6
	objrs.update
...
<!--
	location.href = "validation_etc.asp?mdidx=<%=mdidx%>&tidx=<%=tidx%>";
//-->
</SCRIPT>