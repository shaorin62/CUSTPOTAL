...
<!--
	...
	function go_medium_delete() {
		if (confirm("시스템에서 매체정보가 삭제됩니다.\n\n매체정보를 삭제하시겠습니까?")) {
			location.href = "/od/outdoor/medium_delete_proc.asp?mdidx=<%=mdidx%>&gotopage=<%=gotopage%>&searchstring=<%=searchstring%>";
		}
	}
