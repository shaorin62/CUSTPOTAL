...
<%
	...
	sql = "select highcustcode, custname from sc_cust_hdr where medflag = 'A' and isnull(attr09,0) = 1 order by custname"
	...
	Response.write "<select id='cmbcustcode' name='cmbcustcode' style='width:220px'>"&vbCrLf
