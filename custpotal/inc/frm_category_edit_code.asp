...
<%
	...
	if not isnull(ggroupidx) then
		...
		mstr = "<select name='selmcategory' style='width:320px;' ><option value=''>중분류를 선택하세요.</option>"
		sstr = "<select name='selscategory' style='width:320px;' ><option value=''>소분류를 선택하세요.</option>"
		dstr = "<select name='seldcategory' style='width:320px;' ><option value=''>세분류분류를 선택하세요.</option>"
	end if
