...
<table id="Table_01" width="1240" height="80" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="210" height="80" rowspan="2" valign="top"><a href="/mp/main.asp"><img src="/images/main_01.gif" width="210" height="240" alt="go main" border="0"></a></td>
...
<!--
	...
	function pop_report_view(ridx, midx) {
		var url = "/mp/board/pop_report_view.asp?ridx="+ridx+"&midx="+midx+"&read=y";
	...
	function checkForDownload(name) {
		location.href="/mp/board/download.asp?filename="+name;
	}

	function pop_report_cntupdate(ridx, midx) {
		var url = "/mp/board/report_cntupdate_proc.asp?ridx=" + ridx+"&midx="+midx;
		var name = "" ;
...
//			location.href="report_cntupdate_proc.asp?ridx=" + ridx+"&midx="+midx;
	...
	function pop_report_downcntupdate(ridx, midx) {
		var url = "/mp/board/report_downcntupdate_proc.asp?ridx=" + ridx+"&midx="+midx;
		var name = "" ;
