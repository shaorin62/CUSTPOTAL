...
'	response.End
	...
	For intLoop = 1 To request("contidx").count
		...
		If rs("flag") = "B" Then
			MakeUrlToPrint("http://mms.raed.co.kr/MP/outdoor/print/prt_b_contact.asp?contidx="&request("contidx")(intLoop)&"&cyear="&request("cyear")&"&cmonth="&request("cmonth"))
		Else
			MakeUrlToPrint("http://mms.raed.co.kr/MP/outdoor/print/prt_s_contact.asp?contidx="&request("contidx")(intLoop)&"&cyear="&request("cyear")&"&cmonth="&request("cmonth"))
		End If
		rs.close
