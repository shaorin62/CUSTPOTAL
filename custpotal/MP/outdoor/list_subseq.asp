...
<!--
	...
	// 광고주를 선택 했을때 실행
		...
		_sendRequest("/mp/outdoor/inc/getbrandcode.asp", params, _getbrandcode, "GET");
		_sendRequest("/mp/outdoor/inc/getsubbrandcode.asp",  null, _getsubbrandcode, "GET");
		_sendRequest("/mp/outdoor/inc/getthemecode.asp", null, _getthemecode, "GET");
	...
	function getsubbrandcode() {
		...
		_sendRequest("/mp/outdoor/inc/getsubbrandcode.asp", params, _getsubbrandcode, "GET");
		_sendRequest("/mp/outdoor/inc/getthemecode.asp", null, _getthemecode, "GET");
		document.getElementById("txtsubname").value = "";
		document.getElementById("txtthmname").value = "";
		document.getElementById("hdnsubno").value= "";
	...
	function getthemecode() {
		...
		sendRequest("/mp/outdoor/inc/getthemecode.asp", params, _getthemecode, "GET");
		document.getElementById("txtthmname").value = "";
		document.getElementById("hdnthmno").value = "";
	}
...
//		document.getElementById("debugConsole").innerHTML = params;
		sendRequest("/mp/outdoor/inc/setsubno.asp", params, getsubbrandcode, "GET");
		document.getElementById("txtsubname").value = "";
	}
	...
	function setthmno(crud) {
		...
		sendRequest("/mp/outdoor/inc/setthmno.asp", params, getthemecode, "GET");
		document.getElementById("txtthmname").value = "";
	}
