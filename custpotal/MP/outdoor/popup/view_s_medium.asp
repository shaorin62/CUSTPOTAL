...
//			}
			...
			frm.action = "/MP/outdoor/process/db_s_medium.asp";
			frm.method = "post";
			frm.submit();
		}
		...
		function get_list_medname() {
			...
			sendRequest("/MP/outdoor/inc/getmedname.asp", params, _get_list_medname, "GET");
			}
		}
		...
		function getmedemployee() {
			...
			sendRequest("/MP/outdoor/inc/getmedemployee.asp", params, _getmedemployee, "GET");
		}
...
//			_sendRequest("/MP/outdoor/inc/getmedname.asp", "medname="+ document.getElementById("txtmedname").value, _get_list_medname, "GET");
			calculation();
			_sendRequest("/MP/outdoor/inc/getmedemployee.asp", "medcode="+document.getElementById("cmbmed").value+"&empid=<%=empid%>", _getmedemployee, "GET");
						document.getElementById("cmbmed").attachEvent("onchange", getmedemployee);
			document.getElementById("cmbmed").style.width = '220px';
		}
...
<!--  -->
			...
			<tr>
				...
				<td class="sc"><input name="txtqty" type="text" id="txtqty" maxlength="5"  class="number" onclick='comma(this);' onkeyup="comma(this);" value="<%=qty%>">  <input type="text" id="txtunit" name="txtunit" value="<%=unit%>" style="width:41px;" />  <span style="margin-left:175px;"> <input type="radio" id="common" name='rdotrust' value="C" checked/> 일반  <input type="radio" id="policy" name='rdotrust' value="P" /> 정책 </span></td>
			</tr>
			<tr>
...
<div id="categoryLayer"style="LEFT:10px; TOP:67px; width:520px; height:297px;POSITION:absolute; z-index:11; background-color:#CCCCCC;border: 1px solid #333333;color:#000000;padding:10 10 10 10;font-weight:bolder;display:none;"><!--#include virtual="/MP/outdoor/inc/getMediumClass.asp" --></div>
