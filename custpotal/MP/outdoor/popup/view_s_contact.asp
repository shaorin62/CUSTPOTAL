...
<!--
	...
	function getcontact() {
		...
		var params = "contidx="+contidx+"&cyear="+cyear+"&cmonth="+cmonth;
		sendRequest("/MP/outdoor/inc/getcontactsummary_s.asp", params, _getcontact, "GET");
	}
	...
	function getcontactdetail () {
		...
		sendRequest("/MP/outdoor/inc/getcontactdetail_s.asp", params, _getcontactdetail, "GET");
	}
	...
	function gettheme(mdidx, side) {
		...
		var url = "/MP/outdoor/popup/view_theme.asp?mdidx="+mdidx+"&side="+side+"&highcustcode=<%=highcustcode%>&cyear=<%=pcyear%>&cmonth=<%=pcmonth%>";
		var name = "wintheme";
	...
	function getaccount(mdidx, side) {
		//광고 비용 관리
		var contidx = "<%=pcontidx%>";
		var url = "/MP/outdoor/popup/view_account.asp?contidx="+contidx+"&mdidx="+mdidx+"&side="+side+"&flag=S&cyear=<%=pcyear%>&cmonth=<%=pcmonth%>";
		var name = "winAccount";
		var left = screen.width / 2 - 550 / 2;
		var top = screen.height / 2 - 550 / 2;
		var opt = "width=550, height=550, resizable=no, scrollbars=no, status=yes, left="+left+"&top="+top;
	...
	function setmedium(mdidx) {
		var cyear = document.getElementById("cyear").value;
		var cmonth = document.getElementById("cmonth").value;
		var url = "/MP/outdoor/popup/view_s_medium2.asp?contidx=<%=pcontidx%>&cyear=<%=pcyear%>&cmonth=<%=pcmonth%>&mdidx="+mdidx;
		var name = "medium";
	...
	function getmedium(crud, mdidx) {
		var cyear = document.getElementById("cyear").value;
		var cmonth = document.getElementById("cmonth").value;
		var url = "/MP/outdoor/popup/view_s_medium.asp?contidx=<%=pcontidx%>&cyear=<%=pcyear%>&cmonth=<%=pcmonth%>&mdidx="+mdidx+"&crud="+crud;
		var name = "medium";
		var left = screen.width / 2 - 540 / 2;
	...
	function getprint() {
		var url = "/MP/outdoor/print/prt_s_contact2.asp?contidx=<%=pcontidx%>&cyear=<%=pcyear%>&cmonth=<%=pcmonth%>";
		var name = "Print";
...
//		alert(filename);
		process.location.href = "/MP/outdoor/print/convert_html.asp?filename="+filename+"&contidx=<%=pcontidx%>&cyear=<%=pcyear%>&cmonth=<%=pcmonth%>&flag=S";
	...
	function getmedium2() {
		...
		var url = "/MP/outdoor/popup/view_s_medium2.asp?contidx=<%=pcontidx%>&mdidx="+mdidx;
		var left = screen.width / 2 - 540 / 2;
