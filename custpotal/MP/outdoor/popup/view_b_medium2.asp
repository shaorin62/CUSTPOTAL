...
//			}
		...
		function submitchange() {
			var frm = document.forms[0];
			frm.action = "/MP/outdoor/process/db_b_medium2.asp";
			frm.method = "post";
			frm.submit();
		}
...
<div id="classLayer"style="LEFT:10px; TOP:92px; width:520px; height:270px;POSITION:absolute; z-index:11; background-color:#CCCCCC;border: 1px solid #333333;color:#000000;padding:10 10 10 10;font-weight:bolder;display:none;"><!--#include virtual="/MP/outdoor/inc/getMediumClass.asp" --></div>