...
<!--
		...
		// 광고주를 선택 했을때 실행
			...
			//alert(params);
			_sendRequest("/mp/outdoor/inc/getbrandcombo.asp", params, _getbrandcode, "GET");
			_sendRequest("/mp/outdoor/inc/getthemecombo.asp", params, _getthemecode, "GET");
		}
		...
		function getthemecode() {
			...
			sendRequest("/mp/outdoor/inc/getthemecombo.asp", params, _getthemecode, "GET");
		}
		...
		function getexcel() {
			...
			location.href = "/mp/outdoor/excel/xls_brand.asp?custcode="+custcode+"&teamcode="+teamcode+"&cyear="+cyear+"&cmonth="+cmonth+"&cmbseqno="+cmbseqno+"&cmbthmno="+cmbthmno;
		}
	...
	function debug() {
		...
		window.onload = function () {
			...
			_sendRequest("/mp/outdoor/inc/getbrandcombo.asp", "custcode=<%=pcustcode%>&seqno=<%=cmbseqno%>&Custcodesql=<%=Custcodesql%>", _getbrandcode, "GET");
			//_sendRequest("/mp/outdoor/inc/getsubbrandcombo.asp",  "highseqno=<%=cmbseqno%>&subno=<%=cmbsubno%>", _getsubbrandcode, "GET");
			_sendRequest("/mp/outdoor/inc/getthemecombo.asp", "custcode=<%=pcustcode%>&highseqno=<%=cmbseqno%>&thmno=<%=cmbthmno%>&Custcodesql=<%=Custcodesql%>", _getthemecode, "GET");
			document.getElementById("cmbcustcode").attachEvent("onchange", getteamcombo);
		}
//-->
</script>
