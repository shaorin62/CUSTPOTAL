...
<table width="1024" align="center" style="padding: 10 10 0 10 " cellpadding=0 cellspacing=0 border=0>
	<tr>
		<td><img src='http://mms.raed.co.kr/images/noimage.gif' width='240' height='180' class='noimage'></td>
		<td><img src='http://mms.raed.co.kr/images/noimage.gif' width='240' height='180' class='noimage'></td>
		<td><img src='http://mms.raed.co.kr/images/noimage.gif' width='240' height='180' class='noimage'></td>
		<td><img src='http://mms.raed.co.kr/images/noimage.gif' width='240' height='180' class='noimage'></td>
	</tr>
...
<%
	...
	Function getimage(photo)
		If IsNull(photo) Then
			getimage = "<img src='http://mms.raed.co.kr/images/noimage.gif' width='240' height='180'  class='noimage'>"
		Else
			getimage = "<img src='http://mms.raed.co.kr/pds/media/"&photo&"' width=240' height='180' class='photo' >"
		End If
	End Function
