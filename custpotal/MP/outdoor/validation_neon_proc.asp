...
<%
	...
	dim v_1_6 : v_1_6 = cint(request("1_6"))
	...
	dim sel1_6 : sel1_6 = cint(request("sel1_6"))
	dim a_val : a_val = (v_1_1 + v_1_2+  v_1_3 + v_1_4 + v_1_5 + v_1_6) / 4
	dim a_selval : a_selval = sel1_1 + sel1_2+  sel1_3 + sel1_4 + sel1_5 + sel1_6
	dim a_tot : a_tot = 30
	...
	dim b_val : b_val = (v_2_1 + v_2_2 + v_2_3 + v_2_4 + v_2_5) / 4
	dim b_selval : b_selval = sel2_1 + sel2_2 + sel2_3 + sel2_4 + sel2_5
	dim b_tot : b_tot = 25
	...
	dim v_3_4 : v_3_4 = cint(request("3_4"))
	dim v_3_5 : v_3_5 = cint(request("3_5"))
	dim sel3_1 : sel3_1 = cint(request("sel3_1"))
	dim sel3_2 : sel3_2 = cint(request("sel3_2"))
	dim sel3_3 : sel3_3 = cint(request("sel3_3"))
	dim sel3_4 : sel3_4 = cint(request("sel3_4"))
	dim sel3_5 : sel3_5 = cint(request("sel3_5"))
	dim c_val : c_val =  (v_3_1 + v_3_2 + v_3_3 + v_3_4 + v_3_5) / 4
	dim c_selval : c_selval =  sel3_1 + sel3_2 + sel3_3 + sel3_4 + sel3_5
	dim c_tot : c_tot = 25
	...
	dim v_5_1 : v_5_1 = cint(request("5_1"))
	dim v_5_2 : v_5_2 = cint(request("5_2"))
	dim v_5_3 : v_5_3 = cint(request("5_3"))
	dim v_5_4 : v_5_4 = cint(request("5_4"))
	dim sel5_1 : sel5_1 = cint(request("sel5_1"))
	dim sel5_2 : sel5_2 = cint(request("sel5_2"))
	dim sel5_3 : sel5_3 = cint(request("sel5_3"))
	dim sel5_4 : sel5_4 = cint(request("sel5_4"))
	dim e_val : e_val = (v_5_1 + v_5_2  + v_5_3 + v_5_4) / 4
	dim e_selval : e_selval = sel5_1 + sel5_2 + sel5_3 + sel5_4
	dim e_tot : e_tot = 5
	dim e_fee : e_fee = e_selval / e_tot 
	...
	objrs.fields("value").value = sel1_6
	objrs.update
	...
	objrs.fields("value").value = sel3_4
	objrs.update
	
	objrs.addnew
	objrs.fields("tidx").value = tidx
	objrs.fields("code").value = "sel3_5"
	objrs.fields("value").value = sel3_5
	objrs.update
	...
	objrs.fields("value").value = sel5_1
	objrs.update
	
	objrs.addnew
	objrs.fields("tidx").value = tidx
	objrs.fields("code").value = "sel5_2"
	objrs.fields("value").value = sel5_2
	objrs.update
	
	objrs.addnew
	objrs.fields("tidx").value = tidx
	objrs.fields("code").value = "sel5_3"
	objrs.fields("value").value = sel5_3
	objrs.update
	
	objrs.addnew
	objrs.fields("tidx").value = tidx
	objrs.fields("code").value = "sel5_4"
	objrs.fields("value").value = sel5_4
	objrs.update
...
<!--
	location.href = "validation_neon.asp?contidx=<%=contidx%>&tidx=<%=tidx%>";
//-->
</SCRIPT>