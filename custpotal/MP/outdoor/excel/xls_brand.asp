		...
		if not objrs_1.eof then
			do until objrs_1.eof
				...
				if cmbseqno = "" then
					...
					sql = sql  & " left outer join tmp_subseq_mtx f on e.thmno=f.thmno and seqno like '"&cmbseqno&"%' and subno like '"&cmbsubno&"%' and e.thmno like '"&cmbthmno&"%' "
				...
				Else
					...
					sql = sql  & " inner join tmp_subseq_mtx f on e.thmno=f.thmno and seqno like '"&cmbseqno&"%' and subno like '"&cmbsubno&"%' and e.thmno like '"&cmbthmno&"%'  "
					sql = sql  & " where a.startdate <= '"&edate&"' and a.enddate >= '"&sdate&"'  "
					sql = sql  & " group by a.contidx, a.custcode, a.title, a.startdate, a.enddate, a.flag "
				end if
