          ...
          <tr>
            <td ><table width="1030" height="35" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td  align="left" background="/images/bg_search.gif"> <img src="/images/icon_dot_search.gif" width="4" height="3" align="absmiddle"> 모니터링 검색
				  <%call get_year(cyear)%> <%call get_month(cmonth)%> &nbsp; <span id="custcode2"><%'call get_blank_select("사업부를 선택하세요", 207)%></span><!-- <input type="text" name="txtsearchstring"> --> <img src="../../images/btn_search.gif" width="39" height="20" align="top" class="stylelink" onclick="go_search();"></td>
