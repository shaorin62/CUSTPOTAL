...
<!-- 검색 영역 -->
	...
	<table width="1030" height="35" border="0" cellpadding="0" cellspacing="0" >
	   <tr>
		 ...
		 <td width="20%" align="right" background="/images/bg_search.gif"><img src="/images/btn_excel.gif" width="85" height="22" align="absmiddle" vspace="5" class="stylelink" onclick="get_excel_sheet('trans_01.asp');"></td>
