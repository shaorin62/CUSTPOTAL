...
<!--#include virtual="/hq/top.asp" -->
  <table width="1240" height="700" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="Table_01">
    <tr>
      <td rowspan="2" valign="top"><!--#include virtual="/hq/left_trans_menu.asp"--></td>
      <td height="65" valign="top"><img src="/images/middle_navigater_trans.gif" width="1030" height="65" alt="">
	  <!-- navigation  -->
	  <TABLE  width="1030" style="margin-top:15px;">
            <TR>
				<TD width="500"><img src="/images/ico_subtitle.gif" width="28" height="17" align="absmiddle"><span class="subtitle" id="subtitle">월별 매체별 광고비 </span><span id="subname" class="subtitle"></span></TD>
				<TD width="530" align="right"><span class="navigator"> 광고비 집행 &gt; <span  id="navigator">월별 매체별 광고비 </TD>
            </TR>
            </TABLE>
	  <!--// navigation  -->
	  <!-- search section  -->
			<table width="1030" height="35" border="0" cellpadding="0" cellspacing="0" style="margin-top:18px; margin-bottom:18px;">
                <tr>
	  ...
	  <!--// search section  -->
	  <!-- data view secion   -->
				 <iframe src="public_01.asp" width="1032" height="544" frameborder="2" border="2" name="scriptFrame" id="scriptFrame"></iframe>
	  <!-- //data view secion   -->
	  </td>
    </tr>
	<tr>
...
<!--
	function get_excel_sheet() {
		...
		location.href= "xls_"+url+"?yearmon="+yearmon+"&yearmon2="+yearmon2+"&custcode2="+custcode2;
	}
